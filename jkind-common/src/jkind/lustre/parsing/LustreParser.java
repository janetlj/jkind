...
public class LustreParser extends Parser {
	...
	T__54 = 1, T__53 = 2, T__52 = 3, T__51 = 4, T__50 = 5, T__49 = 6, T__48 = 7, T__47 = 8, T__46 = 9, T__45 = 10,
			T__44 = 11, T__43 = 12, T__42 = 13, T__41 = 14, T__40 = 15, T__39 = 16, T__38 = 17, T__37 = 18, T__36 = 19,
			T__35 = 20, T__34 = 21, T__33 = 22, T__32 = 23, T__31 = 24, T__30 = 25, T__29 = 26, T__28 = 27, T__27 = 28,
			T__26 = 29, T__25 = 30, T__24 = 31, T__23 = 32, T__22 = 33, T__21 = 34, T__20 = 35, T__19 = 36, T__18 = 37,
			T__17 = 38, T__16 = 39, T__15 = 40, T__14 = 41, T__13 = 42, T__12 = 43, T__11 = 44, T__10 = 45, T__9 = 46,
			T__8 = 47, T__7 = 48, T__6 = 49, T__5 = 50, T__4 = 51, T__3 = 52, T__2 = 53, T__1 = 54, T__0 = 55,
			REAL = 56, BOOL = 57, INT = 58, ID = 59, WS = 60, SL_COMMENT = 61, ML_COMMENT = 62, ERROR = 63;
	public static final String[] tokenNames = {
			"<INVALID>", "'{'", "'='", "'int'", "'('", "','", "'var'", "'const'", "'mod'", "'>='", "'<'", "'pre'",
			"'assert'", "']'", "'node'", "'type'", "'<>'", "'let'", "'returns'", "'tel'", "'function'", "'floor'",
			"'then'", "'+'", "'struct'", "'/'", "'of'", "'--%REALIZABLE'", "';'", "'--%PROPERTY'", "'}'", "'if'",
			"':='", "'enum'", "'<='", "'--%MAIN'", "'condact'", "'*'", "'.'", "'->'", "':'", "'--%IVC'", "'['", "'>'",
			"'bool'", "'xor'", "'or'", "'subrange'", "'=>'", "'div'", "'else'", "')'", "'and'", "'not'", "'-'",
			"'real'", "REAL", "BOOL", "INT", "ID", "WS", "SL_COMMENT", "ML_COMMENT", "ERROR"
	};
	public static final int
	RULE_program = 0, RULE_typedef = 1, RULE_constant = 2, RULE_node = 3, RULE_function = 4, RULE_varDeclList = 5,
			RULE_varDeclGroup = 6, RULE_topLevelType = 7, RULE_type = 8, RULE_bound = 9, RULE_property = 10,
			RULE_realizabilityInputs = 11, RULE_ivc = 12, RULE_main = 13, RULE_assertion = 14, RULE_equation = 15,
			RULE_lhs = 16, RULE_expr = 17, RULE_eID = 18;
	public static final String[] ruleNames = {
			"program", "typedef", "constant", "node", "function", "varDeclList", "varDeclGroup", "topLevelType", "type",
			"bound", "property", "realizabilityInputs", "ivc",
		...
		try {
			...
			case 8:
				...
				if ( !(_la==T__34 || _la==T__0) ) {
						((CastExprContext) _localctx).op = _errHandler.recoverInline(this);
				}
				consume();
					setState(266);
					match(T__51);
					...
					case 1:
						...
						_la = _input.LA(1);
								if (!((((_la) & ~0x3f) == 0 && ((1L << _la)
									...
									((BinaryExprContext) _localctx).op = _errHandler.recoverInline(this);
						}
						consume();
								setState(344);
								expr(12);
